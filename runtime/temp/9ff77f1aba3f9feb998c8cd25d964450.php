<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"E:\xampp\xampp\htdocs\disney\public/../application/index\view\personal\bindPhone.html";i:1540370783;s:73:"E:\xampp\xampp\htdocs\disney\application\index\view\common\login-nav.html";i:1540367090;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div id="Content">
        <form id="BindPhone" class="layui-form" action="?">
            <h2>基本信息修改</h2>

            <div id="BindPhoneNav">
                <a href="<?php echo url('safeInfo'); ?>" class="BindPhoneNav-rePwd">
                    <b>密码修改</b>
                </a>
                <a href="#" class="BindPhoneNav-bindPhone">
                    <b>手机号绑定</b>
                </a>
            </div>
            <hr class="rePwd-hr">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inlne">
                    <input type="password" style="width:230px;" name="password" required lay-verify="required" placeholder="请输入新手机号" autocomplete="off" class="layui-input">
                </div>
                <button class="layui-btn sendCode">获取验证码</button>
            </div>

            <div class="layui-form-item">
                <label class="layui-form-label">验证码</label>
                <div class="layui-input-inlne">
                    <input type="password" style="width:400px;" name="password" required lay-verify="required" placeholder="请输入验证码" autocomplete="off" class="layui-input">
                </div>
            </div>

            <div class="layui-form-item">
                <div class="layui-input-block">
                    <button class="layui-btn" style="background-color:#f37942; width:100px;margin-left:20px;" lay-submit lay-filter="formDemo">下一步</button>
